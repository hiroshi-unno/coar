...
module Config = struct
  type strategy =
    ...
    | Classification of CBSynthesizer.Config.t (** configuration for CBSynthesizer [DT/GSC/SCQM/LTB] *)
    | PredicateAbstraction of PASynthesizer.Config.t (** configuration for PASynthesizer [PASAT/PASID] *)
  [@@ deriving yojson]
  type t = {
    verbose: bool;
    strategy: strategy;
