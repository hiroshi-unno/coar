...
let make seeds =
  Set.union
    ...
    (Set.fold_distinct_pairs seeds ~init:Set.Poly.empty ~f:(fun acc (l1, _, r1) (l2, _, r2) ->
         Set.union acc @@
         Set.Poly.of_list
           [T_int.mk_add l1 l2, T_int.mk_add r1 r2;
            T_int.mk_add (T_int.mk_neg l1) l2, T_int.mk_add (T_int.mk_neg r1) r2;
            T_int.mk_add l1 (T_int.mk_neg l2), T_int.mk_add r1 (T_int.mk_neg r2);
