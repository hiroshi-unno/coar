...
(* hint for relational invariant *)
Inv(b1 : bool, len1, h1, i1, b2 : bool, len2, h2, i2) :-
  (b1 and b2 or !b1 and !b2) and len1 = len2 and i1 = i2 or
  b1 and !b2 and len1 + 1 = len2 and i1 = i2 + 1 and i1 <= len1 or
  !b1 and b2 and len1 = len2 + 1 and i1 + 1 = i2 and i2 <= len2.
