(set-logic HORN)
(set-info :source |
  Benchmark: ./benchmarks/ocaml/safety/tacas2015//mc91_95.ml
...
(assert (forall ((x0 Int)) (=> (<= x0 95) (|$P0| x0))))
(assert (not (exists ((x0 Int)(x1 Int)) (and (|$P1| x0 x1) (and (<= x0 95) (or (< x1 91) (> x1 91)))))))
(check-sat)
