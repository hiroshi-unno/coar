(set-logic HORN)
(set-info :source |
  Benchmark: ./benchmarks/ocaml/safety/tacas2015//enc-filter.ml
...
(assert (forall ((x2 Int)(x1 Int)(x0 Int)(x3 Int)(x4 Int)) (=> (and (|$P4| x2 x1) (and (|$P5| x2 x3 x4) (and (or (< x1 0) (> x1 0)) (and (= x1 (+ 1 x3)) (= x0 (+ 1 x4)))))) (|$P5| x2 x1 x0))))
(assert (forall ((x3 Int)(x2 Int)(x0 Int)(x1 Int)) (=> (and (|$P4| x1 x2) (and (|$P1| x3) (and (or (< x2 0) (> x2 0)) (= x2 (+ 1 x0))))) (|$P1| x3))))
(assert (forall ((x3 Int)(x4 Int)(x2 Int)(x0 Int)(x1 Int)) (=> (and (|$P4| x1 x2) (and (|$P1| x3) (and (|$P3| x3 x4) (and (or (< x2 0) (> x2 0)) (= x2 (+ 1 x0)))))) (|$P3| x3 x4))))
...
(assert (not (exists ((x2 Int)(x1 Int)(x0 Int)) (and (|$P5| x0 x1 x2) (>= x2 (+ 1 x1))))))
(check-sat)
