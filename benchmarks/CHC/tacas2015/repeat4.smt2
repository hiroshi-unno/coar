...
(assert (forall ((x3 Int) (x0 Int) (x2 Int) (x1 Int)) (=> (and (P4 x1 x0) (P5 x1 x2 x3) (or (< x0 0) (> x0 0)) (= x0 (+ 1 x2))) (P1 x3))))
(assert (forall ((x1 Int) (x0 Int) (x4 Int) (x2 Int) (x3 Int)) (=> (and (P4 x1 x0) (P5 x1 x2 x3) (P3 x3 x4) (or (< x0 0) (> x0 0)) (= x0 (+ 1 x2))) (P5 x1 x0 x4))))
...
(assert (forall ((x2 Int) (x1 Int) (x0 Int)) (=> (and (P5 x0 x1 x2) (or (< x2 x1) (> x2 x1))) false)))
(check-sat)
