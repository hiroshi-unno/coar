(set-logic HORN)
(set-info :source |
  Benchmark: ./benchmarks/ocaml/safety/tacas2015//enc-zip_map.ml
...
(assert (forall ((x1 Int)(x2 Int)(x0 Int)) (=> (and (|$P2| x1) (and (|$P3| x1 x2) (and (= x0 0) (and (= x1 0) (= x2 0))))) (|$P5| x1 x2 x0))))
...
(assert (forall ((x1 Int)(x0 Int)) (=> (and (|$P4| x1) (and (= x0 0) (= x1 0))) (|$P6| x1 x0))))
...
(assert (not (exists ((x2 Int)(x0 Int)(x1 Int)) (and (|$P5| x0 x0 x1) (and (|$P6| x1 x2) (<= (+ 1 x2) x0))))))
(check-sat)
