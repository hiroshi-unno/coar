(set-logic HORN)
(set-info :source |
  Benchmark: ./benchmarks/ocaml/safety/tacas2015//enc-zip_map2.ml
...
(assert (not (exists ((x0 Int)) (and (|$P2| 0) (and (|$P3| 0 x0) (or (< x0 0) (> x0 0)))))))
(assert (not (exists ((x0 Int)) (and (|$P2| x0) (and (|$P3| x0 0) (or (< x0 0) (> x0 0)))))))
