...
(assert (forall ((x1 Int) (x0 Int)) (=> (and (P0 x1) (= x0 1) (<= x1 0)) (P2 x1 x0))))
(assert (forall ((x0 Int) (x1 Int)) (=> (and (P0 x1) (>= x1 1) (= x1 (+ 1 x0))) (P0 x0))))
(assert (forall ((x1 Int) (x0 Int) (x2 Int) (x3 Int)) (=> (and (P0 x1) (P2 x2 x3) (>= x1 1) (= x1 (+ 1 x2)) (= x0 (+ 2 x3))) (P2 x1 x0))))
...
(assert (forall ((x2 Int) (x0 Int) (x1 Int)) (=> (and (P5 x0 x1 x2) (or (< x2 0) (> x2 0))) false)))
(check-sat)
