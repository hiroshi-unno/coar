...
./script/termcomp20cint/muval_parallel_exc_eps1_tb_ar.sh >./termcomp20cint_tb_ar_parallel_exc_eps1_$1.csv
pkill -9 main
sleep 0.1
echo "call tb ar parallel (exchange_learned_clause eps2):"
./script/termcomp20cint/muval_parallel_exc_eps2_tb_ar.sh >./termcomp20cint_tb_ar_parallel_exc_eps2_$1.csv
pkill -9 main
sleep 0.1
echo "call tb ar parallel (exchange_learned_clause eps0):"
./script/termcomp20cint/muval_parallel_exc_eps0_tb_ar.sh >./termcomp20cint_tb_ar_parallel_exc_eps0_$1.csv
pkill -9 main
sleep 0.1
