...
#rm output
#mkfifo output
(./script/para_aux.sh $timeout ./_build/default/main.exe -c ./config/solver/pcsat_tb_ucore.json $options $1 > output1) &
pid1=$!
(./script/para_aux.sh $timeout ./_build/default/main.exe -c ./config/solver/muval_tb_ucore_prove.json $options $1 > output2) &
pid2=$!
